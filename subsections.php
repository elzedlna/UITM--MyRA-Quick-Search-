              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    ...
                    $sql = "SELECT s.section_order, sb.subsection_no, sb.subsection_malay, sb.subsection_english, sb.date_created FROM subsection sb JOIN section s ON s.section_no = sb.section_no";
                    ...
                    if($result-> num_rows > 0){
                        while ($row = $result-> fetch_assoc()){
                            ...
                            <td>". $row["subsection_malay"]."</td>
                            <td>". $row["subsection_english"]."</td>
